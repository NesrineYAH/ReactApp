...
import monImage from "../../assets/images/bakground/imeneikhlef.webp";
//import { ReactComponent as  } from "../../assets/images/bakground/Sun.svg";
const Profil = () => {
  return (
    <div className="Profil__container">
     
      <div className="Profil_Presentation">
         
        <p className="Piographie">
   ...
   <div className="ImgeProfil">
        <img src="{monImage}" alt="image de portfolio Nes" />
      </div>  
